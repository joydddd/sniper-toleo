#ifndef __QUEUE_MODEL_WINDOWED_MG2_H__
#define __QUEUE_MODEL_WINDOWED_MG2_H__
...
class QueueModelWindowedMG2 : public QueueModel
{
public:
   QueueModelWindowedMG2(String name, UInt32 id, SubsecondTime min_processing_time);
   ~QueueModelWindowedMG2();
